#SNAKE GAME : This is simple python game created with the help of Turtle's module.
#Run this project in jupiter lab.

import turtle
import time
import random

# global variables used in the entire program
window = None
snake = []
head = None
direction = 'down'
...
#Take the colours of your choice from the link given below
...
# keyboard functions to make the snake change direction to up/down/left/right
...
# create the score to see your points on eating food
def create_score():
    global pen
...
# function to update screen after losing the game
def update_screen():
...
def check_body_collisions():
    # if the distance between the head and any of the segments is less than the TURTLE_SIZE
...
# reset screen function to clear the segments of snake if game is lost and start from centre again
def reset():
...
# move function to make the snake move
def move():
    if window._RUNNING:
